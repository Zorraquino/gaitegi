<div id="contact" class="col-span-12 tablet:col-span-6 h-full max-h-[346px] border-b border-solid border-gaitegi-originals-black">
    ...
    <form accept-language="{{ app()->getLocale() }}" wire:submit.prevent="submit" class="h-auto laptop:h-full pb-[152px] laptop:pb-0">
        ...
        <div class="relative h-full grid grid-cols-4 tablet:grid-cols-4 divide-y divide-gaitegi-originals-black">
            ...
            <div class="grid grid-cols-subgrid col-span-4 divide-y tablet:divide-x tablet:divide-y-0 divide-gaitegi-originals-black">
                <div class="col-span-4 tablet:col-span-2 relative !border-b border-solid border-gaitegi-originals-black laptop:!border-b-0">
                ...
                <div class="col-span-4 tablet:col-span-2 relative flex flex-col !border-b border-solid border-gaitegi-originals-black laptop:!border-b-0">
